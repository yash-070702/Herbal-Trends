...
import PurityImage from "../assets/purity-first-botanical.jpg"
import ScientificIntegrityLab from "../assets/scientific-integrity-lab.jpg"
import AnimalWelfareImage from "../assets/animal-welfare-care.jpg"
      ...
      <section className="py-32 px-4 max-w-7xl mx-auto bg-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div
              key={idx}
              className={`group p-8 ${item.color} rounded-[2rem] hover:shadow-2xl hover:shadow-green-950/10 hover:translate-y-[-6px] transition-all duration-500 cursor-pointer border border-transparent ${item.hoverBg} hover:border-white/30`}
            >
              <div
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-gradient-to-t from-green-950/95 via-green-950/60 to-transparent transition-all duration-500"
                style={{
