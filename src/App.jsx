...
const WhatsAppButton = () => {
  ...
  const buildWhatsAppMessage = () => {
    ...
    const isProductPage = pathParts[0] === "product-page"
    ...
    const details = [
      ...
      `Category: ${selectedProduct.category.replace(/-/g, " ")}`,
      `Keyword: ${selectedProduct.keyword}`,
      `Medicine Type: ${selectedProduct.medicineType}`,
      `Physical Form: ${selectedProduct.physicalForm}`,
      `Quantity: ${selectedProduct.quantity}`,
    ]

    return `Hello! I want more info about this product.\n\n${details.join("\n")}`
  }
